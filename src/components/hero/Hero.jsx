  ...
  return (
    <div className="contain flex gap-6">
      <div className="w-full md:w-1/2 p-4 md:pr-10 leading-8 lg:p-8 flex flex-col gap-4">
        ...
        <p id="hl-sub">
          Stream thousands of movies and TV shows — curated recommendations,
          trailers, and easy watch links.
        </p>
        <div className="flex gap-4 ">
          <button className="w-1/2 h-12 md:text-lg border-[#DF3A3A] font-medium border-4 hover:text-xl ">
            Show Plan
          </button>
          <button className="w-1/2 h-12 md:text-lg border-[#DF3A3A] font-medium border-4 hover:text-xl bg-[#DF3A3A]">
            Get Started
          </button>
        </div>
      </div>
